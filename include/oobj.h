...
struct methodblock {
    ...
    void 		*CompiledCodeStub; /* Bug 41337596 */
					   /* Set in JITInitializeClass */
					   /* Used for stubs so we can  */
					   /* free them in JITFreeClass */
...
/*  unsigned                 bcopt_version;
    uint64_t                 bcopt_optimization_mask; */
...
/* #define cbBcoptVersion(cb)    ((unhand(cb))->bcopt_version)           */
/* #define cbBcoptMask(cb)       ((unhand(cb))->bcopt_optimization_mask) */
