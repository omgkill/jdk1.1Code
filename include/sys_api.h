...
extern int64_t sysFileSize(const char *name);
extern int64_t sysSeek64(int fd, int64_t offset, int whence);
extern int     sysFileMode(const char *name);
extern int     sysFileModeF(int fd);
extern int64_t sysFileTime(const char *name);
