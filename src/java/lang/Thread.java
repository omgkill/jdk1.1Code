   ...
   /**
	...
	synchronized (this) {
	    try {
	        ...
	        // If this thread has already completed, and is no longer
	        // a member of any ThreadGroup, catch the resulting
	        // SecurityException.  BugId: 4248436
