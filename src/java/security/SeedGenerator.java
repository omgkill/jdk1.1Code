/*
 * @(#)SeedGenerator.java	1.12 01/12/12
 *
...
class SeedGenerator implements Runnable {
    ...
    // Bug 4191631
    // This static initialization is causing recursive
    // initialization problems with JIT on
    // Return this code to original state when recursion is
    // fixed.
    //private static SeedGenerator myself = new SeedGenerator();
    private static SeedGenerator myself = null;
