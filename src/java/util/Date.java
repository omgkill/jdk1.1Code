...
public class Date implements java.io.Serializable, Cloneable {
     ...
     *
     * If the recognized year number is less than 100, it is interpreted
     * as an abbreviated year relative to a century of which dates are
     * within 80 years before and 19 years after the time when the Date
     * class is initialized.  After adjusting the year number, 1900 is
     * subtracted from it. For example, if the current year is 1999 then
     * years in the range 19 to 99 are assumed to mean 1919 to 1999,
     * while years from 0 to 18 are assumed to mean 2000 to 2018.  Note
     * that this is slightly different from the interpretation of years
